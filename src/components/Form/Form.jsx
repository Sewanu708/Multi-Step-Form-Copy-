...
const Form = ({ Locations, details }) => {
    ...
    return (
        <form className='flex gap-y-4 flex-col' onSubmit={handleSubmit}>
            ...
            <Suggestion data={Locations} handleOnClick={handleOnClick} inputValue={inputValue} path={locale.pathname} comma={comma} setInputValue={setInputValue} setComma={setComma} />
